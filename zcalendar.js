...
(function($){
    ...
    $.fn.zcalendar = function (options) {
        ...
        var opts = $.extend({}, $.fn.zcalendar_defaults(), options);
        var languageSettings = $.fn.zcalendar_language(opts.language);
        opts = $.extend({}, opts, languageSettings);

        this.each(function () {

            var $calendarElement = $(this);
            $calendarElement.attr('id', "zcalendar_" + Math.floor(Math.random() * 99999).toString(36));
            ...
            $calendarElement.data('limitSelection', opts.selectable_dates);
            ...
            function drawCalendar() {
                ...
                var $containerHtml = $('<div class="zcalendar" id="' + $calendarElement.attr('id') + '"></div>');
            ...
            function appendDaysOfMonth($calendarElement, $tableObj, year, month) {
                ...
                var sDates = $calendarElement.data('limitSelection');

                if (typeof(sDates) == 'object') {
                    var sDatesStart = new Date(sDates[0]);
                    var sDatesEnd = new Date(sDates[1]);
                }
                ...
                for (var wk = 0; wk < weeksInMonth; wk++) {
                    ...
                    for (var dow = 0; dow < 7; dow++) {
                        if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                            ...
                            isSelectable = new Date(year, month, currDayOfMonth);
                            ...
                            if (isSelectable >= sDatesStart && isSelectable <= sDatesEnd) {
                                ...
                                $dowElement.addClass('not-available');
    ...
    $.fn.zcalendar_defaults = function () {
    ...
    $.fn.zcalendar_language = function (lang) {
